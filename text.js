...
//     if (/tablet|ipad|playbook|(android(?!.*mobile))/i.test(userAgent)) {
//         return 'tablet';
...
// //     if (/tablet|ipad|playbook|(android(?!.*mobile)|tablet)/i.test(userAgent)) {
// //         return 'tablet';
// //     } else if (/mobile|iphone|ipod|blackberry|opera mini|iemobile|windows phone|trident|opera mobi|mobilesafari|htc|nokia|sony|symbian|samsung|lg|mot/i.test(userAgent)) {
// //         return 'mobile';
// //     } else {
// //         return 'pc';
// //     }
...
//   // Function to parse user agent string and detect device
